...
export function ConversationSidebar({ onSelectConversation, selectedId, refreshTrigger }: ConversationSidebarProps) {
  const { user } = useUser();
  ...
  return (
    <div className="w-64 bg-gray-100 border-r border-gray-300 p-4 overflow-y-auto max-h-screen">
